...
namespace Articy.Quantum_Dynamics.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Quantum_Dynamics.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Quantum_Dynamics.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
        ...
        {
            Articy.Quantum_Dynamics.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Quantum_Dynamics.Features.DefaultBasicCharacterFeatureFeature();
